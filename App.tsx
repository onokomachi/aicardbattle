...
import { INITIAL_HP, HAND_SIZE, DECK_SIZE, INITIAL_UNLOCKED_CARDS, CardCatalogById, CARD_DEFINITIONS, ADMIN_EMAILS } from './constants';
        ...
        <div className="relative z-10 w-full h-full">
            {gameState === 'login_screen' && (
                <TopScreen 
                    ...
                    onOpenGameMaster={canAccessGameMaster ? () => setGameState('gamemaster') : undefined}
                />
            )}
