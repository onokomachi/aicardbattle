...
export type TurnPhase = 'player_turn' | 'pc_turn' | 'resolution_phase' | 'battle_animation';
// Add 'matchmaking' state
export type GameState = 'login_screen' | 'deck_building' | 'matchmaking' | 'in_game' | 'end';
